...
public class Constant {
	...
	// 如果为“0”表示订单永不过期
	private static int unPayFailureMinute = 120;
...
//	private static Map<Integer, AppVersionDTO> appVersionMap = Maps.newHashMap();
	...
	public static String getH5ArticleUrl() {
		return new StringBuilder().append(H5Url).append("/#/discovery-detail?id=").toString();
	}
	
	public static String getH5InviteUrl() {
		return new StringBuilder().append(H5Url).append("/#/invite?id=").toString();
	}
