package com.innee.czyhInterface.util.publicImage.util;
...
public final class Auth {
	...
	private static final long DEADLINETOKEN = 86400;//token失效时间
    /**
     * 上传策略，参数规格详见
     * <p/>
    ...
    public String privateDownloadUrl(String baseUrl) {
        return privateDownloadUrl(baseUrl, DEADLINETOKEN);
    }
    ...
    public String uploadToken(String bucket) {
        return uploadToken(bucket, null, DEADLINETOKEN, null, true);
    }
    ...
    public String uploadToken(String bucket, String key) {
        return uploadToken(bucket, key, DEADLINETOKEN, null, true);
    }
