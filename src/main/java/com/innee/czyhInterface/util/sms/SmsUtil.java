...
public class SmsUtil {
	...
	/**
	 * 模板类型: 短信通知 模板名称: 零到壹用户订单支付成功通知 模板ID: SMS_6080657 模板内容:
	 * 您的订单${orderName}已经支付成功，您可以在${orderList}中查看订单详细信息。到店后，
	 * 商家扫描订单二维码或手动输入电子码即可完成消费。 申请说明: 当用户下单支付成功后，系统通知用户订单支付成功
	 */
	private static final String PaySuccessSmsId = "SMS_6080657";

	/**
	 * 模板类型: 短信通知 模板名称: 零到壹订单核销成功通知 模板ID: SMS_6135592 模板内容:
	 * 您的订单${orderName}已经消费成功。如有问题，可关注${platform}微信公众号咨询或拨打客服电话：${
	 * customerServiceTel} 申请说明: 用户消费核销成功后的通知
	 */
	private static final String VerificationSuccessSmsId = "SMS_6135592";
	...
	public static void main(String[] args) {
		...
		SmsResult smsResult = SmsUtil.sendSms(SmsUtil.PaySuccessSms, "15810716415", smsParamMap);
		...
		// SmsResult smsResult = SmsUtil.sendSms(SmsUtil.QuestionnaireSurveySms,
